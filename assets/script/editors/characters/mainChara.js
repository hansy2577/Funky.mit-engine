...
function getCharacters() {
    ...
    var reload = 0;
    rawFile.open("get", document.getElementById("file").value+"/main.fmc", true);
    rawFile.onreadystatechange = function() {
      ...
      if (reload == 3) {
        if (allText == "Error 404, file not found.") {
          PreError("fail to load '"+document.getElementById("file").value+".json' "+" reson: " + allText, false, false)
        } else {
          alert("anim load")
...
function addExtratAnim() {
  ...
  makeLocalAnim(name, document.getElementById("file").value+ editor.chara.animations[name].anim, editor.chara.animations[name][name], 100, 80, editor.chara.scale, "GAME", editor.chara.animations[naùe]["speed"], editor.chara.animations[name]["isloop ?"])
  document.getElementById("s").style.scale = 1
}
  
function loadCharacther() {
    makeLocalAnim("N", document.getElementById("file").value+"/"+ editor.chara.animations["Neutre"].anim, editor.chara.animations["Neutre"]["length"], 100, 80, editor.chara.scale, "GAME", editor.chara.animations["Neutre"]["speed"], editor.chara.animations["Neutre"]["isloop ?"], editor.chara.animations["Neutre"]["position"][0], editor.chara.animations["Neutre"]["position"][1])
    makeLocalAnim("L", document.getElementById("file").value+"/"+ editor.chara.animations["L"].anim, editor.chara.animations["L"]["length"], 100, 80, editor.chara.scale, "GAME", editor.chara.animations["L"]["speed"], editor.chara.animations["L"]["isloop ?"] ,editor.chara.animations["L"]["position"][0], editor.chara.animations["L"]["position"][1])
    makeLocalAnim("U", document.getElementById("file").value+"/"+ editor.chara.animations["U"].anim, editor.chara.animations["U"]["length"], 100, 80, editor.chara.scale, "GAME", editor.chara.animations["U"]["speed"], editor.chara.animations["U"]["isloop ?"] ,editor.chara.animations["U"]["position"][0], editor.chara.animations["U"]["position"][1])
    makeLocalAnim("D", document.getElementById("file").value+"/"+ editor.chara.animations["D"].anim, editor.chara.animations["D"]["length"], 100, 80, editor.chara.scale, "GAME", editor.chara.animations["D"]["speed"], editor.chara.animations["D"]["isloop ?"] ,editor.chara.animations["D"]["position"][0], editor.chara.animations["D"]["position"][1])
    makeLocalAnim("R", document.getElementById("file").value+"/"+ editor.chara.animations["R"].anim, editor.chara.animations["R"]["length"], 100, 80, editor.chara.scale, "GAME", editor.chara.animations["R"]["speed"], editor.chara.animations["R"]["isloop ?"] ,editor.chara.animations["R"]["position"][0], editor.chara.animations["R"]["position"][1])
...
function BG() {
  document.getElementById("BG reference").src = document.getElementById("BGfile").value
}
  /*
  let bfIdle = 0;
  let dadIdle = 0;

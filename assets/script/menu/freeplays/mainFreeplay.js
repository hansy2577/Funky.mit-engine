...
function freeplay() {
  setInterval(() => {
    if (menu.songSelectioned !== null) {
      if (menu.inFreeplay == true) {
        ...
        var color = HJS_makeCSSanim("BGcolor", 0.9, "ease-in", "1", [
  ...
  for (var i = 0; i < menu.songList.song.list.length; i++) {
    MakeSongElement(menu.songList.song.data[menu.songList.song.list[i]].name,i,menu.songList.song.list[i])
  }

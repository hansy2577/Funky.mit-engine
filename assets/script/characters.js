...
function loadCharacther2() {
  loadanim_Dad_N(game.data.dad.src +"/"+ game.data.dad.animations["Neutre"].anim,"Dad N",game.data.dad["alt name"],game.song.metadata.assets.dad[1],game.song.metadata.assets.dad[2],game.data.dad.scale,game.data.dad.animations["Neutre"]["length"],game.data.dad.animations["Neutre"]["speed"]);
  
  loadanim_Dad_L(game.data.dad.src +"/"+ game.data.dad.animations["L"].anim,"Dad L",game.data.dad["alt name"],game.song.metadata.assets.dad[1],game.song.metadata.assets.dad[2],game.data.dad.scale,game.data.dad.animations["L"]["length"],game.data.dad.animations["L"]["speed"]);
  loadanim_Dad_U(game.data.dad.src +"/"+ game.data.dad.animations["U"].anim,"Dad U",game.data.dad["alt name"],game.song.metadata.assets.dad[1],game.song.metadata.assets.dad[2],game.data.dad.scale,game.data.dad.animations["U"]["length"],game.data.dad.animations["U"]["speed"]);
  loadanim_Dad_D(game.data.dad.src +"/"+ game.data.dad.animations["D"].anim,"Dad D",game.data.dad["alt name"],game.song.metadata.assets.dad[1],game.song.metadata.assets.dad[2],game.data.dad.scale,game.data.dad.animations["D"]["length"],game.data.dad.animations["D"]["speed"]);
  loadanim_Dad_R(game.data.dad.src +"/"+ game.data.dad.animations["R"].anim,"Dad R",game.data.dad["alt name"],game.song.metadata.assets.dad[1],game.song.metadata.assets.dad[2],game.data.dad.scale,game.data.dad.animations["R"]["length"],game.data.dad.animations["R"]["speed"]);
}
...
function Boyfriend(x,y,name) {
  ...
  game.stage.dad.style.position = "absolute";
  game.stage.dad.src = "mods/"+game.modsSelect+"/"+game.song.metadata.assets.BG[0]
  game.stage.dad.style.left = game.song.metadata.assets.BG[1] + "px";

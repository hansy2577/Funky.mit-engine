...
if (sessionStorage.getItem("game") == undefined) {
  PreError("fail to get data from 'menu.html', try again", true, false)
}
...
function Dad_L() {
  ...
  document.getElementById("Dad L").style.scale = 1;
  playAnim_Dad_L()
}
...
function Dad_U() {
  ...
  document.getElementById("Dad U").style.scale = 1;
  playAnim_Dad_U()
}
...
function Dad_D() {
  ...
  document.getElementById("Dad D").style.scale = 1;
  playAnim_Dad_D()
}
...
function Dad_R() {
  ...
  document.getElementById("Dad R").style.scale = 1;
  playAnim_Dad_R()
}

hideDad()
function hideDad() {
  document.getElementById("Dad N").style.scale = 0.0001
...
var camLoop = setInterval(() => {
  ...
  // auto cam scroll
  if (game.cam.autoCam == true && game.canMoveNote == true && game.pauseGameState == false && game.canStart == true && game.BPM.beat4Hit == true) {
